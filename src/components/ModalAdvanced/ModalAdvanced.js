          ...
          <div class="modal-content">
            ...
            <form method="post" action="" id="form-apply-cv" enctype="multipart/form-data">
              ...
              <div class="modal-header">
                ...
                <h4 class="modal-title bold">Score <span class="text-highlight">{gContext.jobPostName}</span></h4>
              </div>
              ...
              <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-topcv-primary btn-theme" id="btn-apply" onClick={onClickAdvanced}>Nộp CV</button>
